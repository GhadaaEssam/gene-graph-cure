...
class RAGService:
    ...
    def generate_evidence(
        ...
        top_genes = self._extract_top_genes_from_result(prediction_result, limit=5)
        top_pathways = self._extract_top_pathways_from_result(prediction_result, limit=5)
        is_multiomics = any(
    ...
    def _extract_top_genes_from_result(
        self,
        prediction_result,
        limit=5
    ):
    ...
    def _extract_top_pathways_from_result(
        self,
        prediction_result,
        limit=5
    ):
